...
def generate_launch_description():
    ...
    # Master robot simulator node - only load config file, no parameter overrides
    master_simulator_node = Node(
        package='mujoco_sim',
        executable='simulator',
        name='mujoco_simulator_master',
        output='screen',
        parameters=[master_config_file]
    )
