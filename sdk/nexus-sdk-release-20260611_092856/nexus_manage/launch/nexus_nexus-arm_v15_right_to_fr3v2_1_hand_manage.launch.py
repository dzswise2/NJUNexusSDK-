"""
Teleop Manager Node Launch File - Nexus-Arm V15 Right to Franka FR3v2.1 + Hand
"""
...
def launch_setup(context, *args, **kwargs):
    ...
    base_name = 'nexus_arm_v15_right_to_fr3v2_1_hand_manager_node'
...
def generate_launch_description():
    ...
    default_config = os.path.join(
        pkg_share, 'config',
        'nexus-arm_v15_right_to_fr3v2_1_hand_manage.yaml')

    return LaunchDescription([
        DeclareLaunchArgument(
            'nexus_manage_config_file',
            default_value=default_config,
            description='Path to teleop manager configuration file',
        ),
