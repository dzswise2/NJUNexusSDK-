...
namespace KDL{
    ...
    public:
        ...
        void SetGravD(const Vector& grav);
         ...
         * 后加函数, 放在github上
         */
        int CartToJnt(const JntArray &q, const JntArray &q_dot, const JntArray &q_dotdot, const RigidBodyInertia& load,JntArray &torques);
