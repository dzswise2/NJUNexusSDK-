...
本目录包含从 yunji_sdk 引入的公共库，供 teleop_app 包内部使用。
...
**用法示例**：
```cpp
#include "teleop_app/common/thread/rt_thread.hpp"
...
**用法示例**：
```cpp
#include "teleop_app/common/fsm/state_machine.hpp"
#include "teleop_app/common/fsm/state_interface.hpp"
...
这些库来自 yunji_sdk 项目：
- `yunji_sdk/include/yunji/thread/` → `teleop_app/include/teleop_app/common/thread/`
- `yunji_sdk/include/yunji/robot/fsm/` → `teleop_app/include/teleop_app/common/fsm/`
- `yunji_sdk/src/yunji/robot/fsm/` → `teleop_app/src/common/fsm/`
